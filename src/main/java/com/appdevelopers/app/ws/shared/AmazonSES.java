package com.appdevelopers.app.ws.shared;
...
//import com.amazonaws.services.simpleemail.model.SendEmailResult;
	...
	public class AmazonSES {
		...
		final String FROM = "mannumnv671@gmail.com";
		...
		public void verifyEmail(UserDto userDto) {
			...
			System.setProperty("aws.accessKeyId", "AKIAR7CIPJ625YCHOKSN"); 
			System.setProperty("aws.secretKey", "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"); 
			
			AmazonSimpleEmailService client = AmazonSimpleEmailServiceClientBuilder.standard().withRegion(Regions.AP_NORTHEAST_1)
					.build();
